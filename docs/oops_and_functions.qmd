...
#subset to only keep rows where column_name matches fish_name, otherwise considers milkfish for all three!
  parameters <- fish_parms[fish_parms$common_name == fish_name, ]
